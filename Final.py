...
def registrar_usuario():
    ...
    Propósito: Permite al usuario registrarse en el sistema ingresando un correo electrónico válido.
    """
    print("\n===== REGISTRO DE USUARIO =====")
    ...
    usuarios_registrados.append((mail,contraseña))
...
def validar_usuario():
    ...
    #Se le pide un correo electrónico al usuario
        ...
        for usuario in usuarios_registrados:
            if usuario[0] == mail and usuario[1]==contraseña:
                encontrado = True
                break
        if encontrado:
